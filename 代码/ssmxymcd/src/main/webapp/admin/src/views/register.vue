  ...
  <div>
    <div class="container">
      <div class="login-form" style="backgroundColor:rgba(255, 255, 255, 0.53);borderRadius:10px">
        <h1 class="h1" style="color:rgba(101, 126, 253, 1);fontSize:25px;">学生公寓电费信息管理系统小程序注册</h1>
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm" label-width="120px">
															<!-- <div v-if="tableName=='gongyuguanliyuan'" class="input-group">
			   <div class="label">账号</div>
			   <div class="input-container">
			     <input v-model="ruleForm.zhanghao" class="input" type="text" placeholder="账号">
			   </div>
			 </div> -->
			<el-form-item label="账号" class="input" v-if="tableName=='gongyuguanliyuan'">
			...
			<el-form-item label="密码" class="input" v-if="tableName=='gongyuguanliyuan'">
			...
			<el-form-item label="姓名" class="input" v-if="tableName=='gongyuguanliyuan'">
			...
			<el-form-item label="年龄" class="input" v-if="tableName=='gongyuguanliyuan'">
			...
			<el-form-item label="手机" class="input" v-if="tableName=='gongyuguanliyuan'">
			...
			<el-form-item label="身份证" class="input" v-if="tableName=='gongyuguanliyuan'">
...
export default {
  ...
  methods: {
    ...
    // 注册
    login() {
                              if((!this.ruleForm.zhanghao) && `gongyuguanliyuan` == this.tableName){
        this.$message.error(`账号不能为空`);
        return
      }
                                                                  if((!this.ruleForm.mima) && `gongyuguanliyuan` == this.tableName){
        this.$message.error(`密码不能为空`);
        return
      }
                                                                  if((!this.ruleForm.xingming) && `gongyuguanliyuan` == this.tableName){
...
<style lang="scss" scoped>
 ...
 //  }
	...
	.container {
		background-image: url("http://codegen.caihongy.cn/20210313/274d9a23f74d47dfb196e38d2c227009.jpeg");
		height: 100vh;
