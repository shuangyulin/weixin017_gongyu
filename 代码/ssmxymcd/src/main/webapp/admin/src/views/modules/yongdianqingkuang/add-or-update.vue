          ...
          <el-form-item class="input" label="学生姓名" prop="xueshengxingming">
              <el-input v-model="ruleForm.xueshengxingming" 
                placeholder="学生姓名" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="楼称号" prop="louchenghao">
          <el-input v-model="ruleForm.louchenghao" 
              placeholder="楼称号" clearable  :readonly="ro.louchenghao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="楼称号" prop="louchenghao">
              <el-input v-model="ruleForm.louchenghao" 
                placeholder="楼称号" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="用电量" prop="yongdianliang">
          <el-input v-model="ruleForm.yongdianliang" 
              placeholder="用电量" clearable  :readonly="ro.yongdianliang"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="用电量" prop="yongdianliang">
              <el-input v-model="ruleForm.yongdianliang" 
                placeholder="用电量" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
          ...
          <el-form-item class="input" label="金额" prop="jine">
              <el-input v-model="ruleForm.jine" 
                placeholder="金额" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="用电余额" prop="yongdianyue">
          <el-input v-model="ruleForm.yongdianyue" 
              placeholder="用电余额" clearable  :readonly="ro.yongdianyue"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="用电余额" prop="yongdianyue">
              <el-input v-model="ruleForm.yongdianyue" 
                placeholder="用电余额" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
...
export default {
  ...
  methods: {
      ...
      this.$http({
        ...
        if (data && data.code === 0) {
                ...
                this.ruleForm.xueshengxingming = data.data.xueshengxingming
                                                ...
                                                if(data.data.louchenghao){
                this.ruleForm.louchenghao = data.data.louchenghao
              }
                                                                                                                                                                                                                                                          } else {
          this.$message.error(data.msg);
        }
	...
	this.ruleForm.beizhu = this.ruleForm.beizhu.replace(reg,'../../../ssmxymcd/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `yongdianqingkuang/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.yongdianqingkuangCrossAddOrUpdateFlag = false;
                  this.parent.search();
